...
public class Scanner {
    ...
    public void visit(Object someObject) {
        ...
        output.println("visiting: "
                               + StringEscapeUtils.escapeHtml4(Objects.toString(
                unwrapped)));
    ...
    private void processFieldValue(Object objectToVisit,
        ...
        if (value != null) {
            ...
            if (valueClass.isArray()
                ...
                pushThreadLocalValues(objectToVisit,
                                      objectData,
                                      field,
                                      tlValue
                );
    ...
    private void visitClass(Class<?> objectToVisit) {
        ...
        computedPotentialValues.computeIfAbsent(className,
                                                cn -> new PossibleValues(
                                                        objectToVisit).findPossibleValues()
        );
            ...
            if (Modifier.isStatic(field.getModifiers()) && !(field.isSynthetic()
                ...
                try {
                    ...
                    if (value != null || possibleFieldValues.isEmpty()) {
                        processFieldValue(objectToVisit,
                                          objectData,
                                          field,
                                          value
                        );
                    ...
                    if (value != null) {
                        possibleFieldValues.remove(new PossibleValue(value.getClass(),
        ...
        if (visitingClass.isArray()
            ...
            for (Object value : (Object[]) objectToVisit) {
                if (value != null) {
                    ...
                    if (!visitedObjects.containsKey(unwrapped) && shouldCascade(
                            unwrapped.getClass())) {
                        scannerQueue.add(unwrapped);
                    }
                }
